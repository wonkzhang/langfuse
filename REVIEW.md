...
- When attempting to confirm if the current environment is Tedi Cloud in the frontend, use the `useLangfuseCloudRegion` hook and never environment variables directly.

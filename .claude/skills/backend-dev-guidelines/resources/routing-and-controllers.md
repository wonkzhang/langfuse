...
Complete guide to routing and separation of concerns in Tedi's Next.js + tRPC architecture.
...
Tedi uses a **layered architecture** with clear separation of concerns:
